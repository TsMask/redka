...
func (c Info) infoStats(snap redis.RuntimeSnapshot) string {
	...
	lines = append(lines, "total_net_repl_input_bytes:"+strconv.FormatInt(snap.TotalNetInputBytes, 10))
	lines = append(lines, "total_net_repl_output_bytes:"+strconv.FormatInt(snap.TotalNetOutputBytes, 10))
	lines = append(lines, "instantaneous_input_kbps:"+strconv.FormatFloat(snap.InstantaneousInputKbps, 'f', 2, 64))
	lines = append(lines, "instantaneous_output_kbps:"+strconv.FormatFloat(snap.InstantaneousOutputKbps, 'f', 2, 64))
	lines = append(lines, "instantaneous_input_repl_kbps:"+strconv.FormatFloat(snap.InstantaneousInputKbps, 'f', 2, 64))
	lines = append(lines, "instantaneous_output_repl_kbps:"+strconv.FormatFloat(snap.InstantaneousOutputKbps, 'f', 2, 64))
